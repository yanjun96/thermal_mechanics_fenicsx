def main_thermal(pa, type, angular1, mesh_max1, c_contact1):
  ...
  ## C = [188, 259, 445]
   ...
   for parameter_c in pa:
      ...
      source_dir = "/cfs/klemming/projects/snic/naiss2023-5-559/project/therm_disc/implicit/tetrahedron"
      
      # Define the destination directory
      if type == "time_step" :
          destination_dir = "/cfs/klemming/projects/snic/naiss2023-5-559/project/therm_disc/implicit/tetrahedron/implicit_dt"

      if type == "mesh_size" :
          destination_dir = "/cfs/klemming/projects/snic/naiss2023-5-559/project/therm_disc/implicit/tetrahedron/implicit_dx"

      if type == "contact_area" :
          destination_dir = "/cfs/klemming/projects/snic/naiss2023-5-559/project/therm_disc/implicit/tetrahedron/implicit_dc"
