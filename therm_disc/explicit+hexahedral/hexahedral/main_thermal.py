  ...
  ## C = [188, 259, 445]
   ...
   for parameter_c in pa:
      ...
      if os.path.exists(mesh_filename1):
          ...
          mesh_brake_disc(mesh_min, mesh_max, mesh_filename2, 'hexa')
          domain, cell_markers, facet_markers = gmshio.read_from_msh(
              mesh_filename1, MPI.COMM_WORLD, 0, gdim=3
          )
      ...
      source_dir = "/home/yanjun/documents/fenicsx/project/therm_disc/implicit/hexahedral"
      
      # Define the destination directory
      if type == "time_step" :
          destination_dir = "/home/yanjun/documents/sim_results/hexa/implicit_dt"

      if type == "mesh_size" :
          destination_dir = "/home/yanjun/documents/sim_results/hexa/implicit_dx"

      if type == "contact_area" :
          destination_dir = "/home/yanjun/documents/sim_results/hexa/implicit_dc"
